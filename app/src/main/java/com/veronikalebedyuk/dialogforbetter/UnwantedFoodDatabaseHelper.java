...
public class UnwantedFoodDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "UnwantedFoodDatabase";
    public static final String COL_1 = "ID";
    public static final String COL_2 = "name";
    public static final String COL_3 = "value";

    public UnwantedFoodDatabaseHelper(Context context) {
